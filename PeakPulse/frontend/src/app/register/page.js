...
/>
        ...
        <main className="flex flex-col items-center justify-center min-h-screen p-6 bg-gray-100 dark:bg-gray-900">
          <div className="w-full max-w-md bg-[#98d8e4] p-8 rounded-lg shadow-lg dark:bg-[#98d8e4] mt-6">
            ...
            <h2 className="text-2xl font-bold mb-6 text-center dark:text-black">Create Account</h2>
            <form>
              <div className="mb-4">
                ...
                <input
                  type="text"
                  id="username"
                  className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 dark:bg-white-700 dark:border-gray-600 dark:text-white"
                  placeholder="Enter your username"
                  required
                />
              </div>
              <div className="mb-4">
                <label htmlFor="email" className="block text-gray-800 font-medium mb-2 dark:text-gray-400">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div className="mb-6">
                <label htmlFor="confirm-password" className="block text-gray-800 font-medium mb-2 dark:text-gray-400">
                  Confirm Password
                </label>
                <input
                  type="password"
