    ...
    <>
      <header className="w-full flex items-center p-4 bg-white shadow-md dark:bg-gray-800">
        <div className="flex items-center space-x-4">
          <img src="/peakpulselogo1.png" className="h-10 w-10" alt="PeakPulse Logo" />
          <h1 className="text-xl font-bold text-gray-800 dark:text-white">PeakPulse</h1>
        </div>
      </header>
      <div class="flex flex-row h-full">
      <nav class="bg-white shadow-md dark:bg-gray-800 w-34 flex flex-col p-4">
      <div class="mt-10">
    <ul class="space-y-6">
      <li>
        <a href="#" class="flex items-center">
          <span class="mr-2">
            <svg class="fill-current h-5 w-5 text-gray-300 hover:text-green-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <span class="text-gray-700 dark:text-gray-300">Gym Profiling</span>
        </a>
      </li>
      <li>
        <a href="#" class="flex items-center">
          <span class="mr-2">
            <svg class="fill-current h-5 w-5 text-gray-300 hover:text-green-500" viewBox="0 0 24 24">
